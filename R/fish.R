...
#'
#' @details This dataset contains delta^{15}N, delta^{13}C, and delta^{34}S values for the following fish species:
#' \itemize{
#'   \item ARCS - Arctic Cisco (*Coregonus autumnalis*), n = 69
#'   \item BDWF - Broad Whitefish (*Coregonus nasus*), n = 71
#'   \item LKWF - Lake Whitefish (*Coregonus clupeaformis*), n = 67
#'   \item LSCS - Least Cisco (*Coregonus sardinella*), n = 70
#' }
#'
